...
const STALE_STRUCTURED_REFRESH_PER_RUN = 225; // Gradually rewrite legacy flat WD/SR sidecars into dual-text structured entries while staying inside the normal ENR runtime target.
