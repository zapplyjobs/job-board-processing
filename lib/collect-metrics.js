...
function computeEvergreenMetrics() {
  ...
  try {
    ...
    let withFirstPublished = 0, firstPublishedFresh03 = 0, firstPublishedEvergreen = 0;
    ...
    for (const line of lines) {
      ...
      if (job.first_published) {
        ...
        if (fpAge <= 3) firstPublishedFresh03++;
        if (fpAge > 10) firstPublishedEvergreen++;
      }
    ...
    return {
      ...
      first_published_evergreen_pct: withFirstPublished > 0 ? Math.round(firstPublishedEvergreen / withFirstPublished * 1000) / 10 : null,
