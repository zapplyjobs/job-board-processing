...
// Config
// ---------------------------------------------------------------------------
const ENRICHER_VERSION = 80;   // ENR-VISA-10: reprocess Oracle page-description visa text after cached-description fallback fix
...
const reservedStale = [...staleNoDesc, ...staleNoSkills, ...staleNoVisa, ...staleOther].slice(0, Math.min(staleReserve, fastBatchSize));
