...
const { loadDescriptionsMap, resolveActiveChunk, fetchMissingDescriptions, refreshStaleSrDescriptions, refreshStaleContentDescriptions, buildWdDescUrl, buildSrDescUrl, quickGet, loadFailCache, saveFailCache } = require('./enrich/description-fetcher');
...
const enrichmentStats = generateStats({ allJobs, finalLines, processedMap, descriptionsMap, DATA_DIR, ENRICHER_VERSION, descWaiting, reenrichmentPending, enrichmentStartedAt: ENRICHMENT_STARTED_AT });
}
}
