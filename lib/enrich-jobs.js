...
const { map: descriptionsMap, enrichedIds: descEnrichedIds, flatIds: descFlatIds, staleByAgeIds: descStaleByAgeIds } = loadDescriptionsMap();
...
const enrichmentStats = generateStats({ allJobs, finalLines, processedMap, descriptionsMap, DATA_DIR, ENRICHER_VERSION, descWaiting, reenrichmentPending, enrichmentStartedAt: ENRICHMENT_STARTED_AT, failCache: failCacheForStats, sidecarReadAt: SIDECAR_READ_AT });
