...
const { loadDescriptionsMap, resolveActiveChunk, fetchMissingDescriptions, buildWdDescUrl, buildSrDescUrl, quickGet, loadFailCache, saveFailCache } = require('./enrich/description-fetcher');
