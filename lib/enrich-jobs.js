...
// Config
// ---------------------------------------------------------------------------
const ENRICHER_VERSION = 88;   // ENR-C181 (D1): description freshness — fetched_at signal + bounded content-staleness refresh for WD/SR on-demand descriptions (FLIR-class); v88 re-enriches so refreshed text flips visa/degree signals on already-current rows.
