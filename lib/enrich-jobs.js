...
// Config
// ---------------------------------------------------------------------------
const ENRICHER_VERSION = 64;   // SR-STALE: Re-fetch stale SR descriptions with qualifications section
...
const enrichmentStats = generateStats({ allJobs, finalLines, processedMap, descriptionsMap, DATA_DIR, ENRICHER_VERSION, descWaiting, reenrichmentPending, rescuedExhausted });
}
}
