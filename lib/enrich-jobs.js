...
console.log(`[enrich-jobs] Descriptions loaded: ${descriptionsMap.size} entries (${descEnrichedIds.size} from enriched sidecars, ${descFlatIds.size} legacy flat entries, ${descStaleByAgeIds.size} stale-by-age)`);
...
const enrichmentStats = generateStats({ allJobs, finalLines, processedMap, descriptionsMap, DATA_DIR, ENRICHER_VERSION, descWaiting, reenrichmentPending, enrichmentStartedAt: ENRICHMENT_STARTED_AT, failCache: failCacheForStats });
