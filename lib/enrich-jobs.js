...
// Config
// ---------------------------------------------------------------------------
const ENRICHER_VERSION = 87;   // ENR-C180: narrow VISA-10 negative-phrase regexes (candidate U.S. person, Q-level clearance citizenship, auth-without-sponsorship noun-form)
...
const { map: descriptionsMap, enrichedIds: descEnrichedIds, flatIds: descFlatIds } = loadDescriptionsMap();
console.log(`[enrich-jobs] Descriptions loaded: ${descriptionsMap.size} entries (${descEnrichedIds.size} from enriched sidecars, ${descFlatIds.size} legacy flat entries)`);
