...
const STRUCTURALLY_LOW_SKILLS = new Set(['simplify', 'apple', 'google', 'jsearch', 'microsoft', 'oracle']);
...
const NO_SIDECAR_SOURCES = {
  ...
  disabled: new Set(['apple', 'google', 'oracle']),
};
